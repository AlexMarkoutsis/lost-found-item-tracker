...
class AuthApiTests(TestCase):
    ...
    def test_register_returns_json_response(self):
        payload = {
            "username": "user@email.com",
            "password": "Password",
        }
        ...
        self.assertTrue(
            hasattr(res, "data") or res["Content-Type"].startswith("application/json")
        )
    ...
    def test_duplicate_register_does_not_create_second_user(self):
        User.objects.create_user(username="user@email.com", password="Password")
        ...
        self.assertEqual(User.objects.filter(username="user@email.com").count(), 1)
    ...
    def test_login_success_response_contains_success_flag(self):
        User.objects.create_user(username="user@email.com", password="Correct")
    ...
    def test_login_failure_response_contains_error_message(self):
        payload = {
            "username": "user@email.com",
